...
def set_sheet_id(settings, requests_mock):
...
def test_create_non_existing_and_update_existing_notifications(
    ...
    NotificationImporter().create_non_existing_and_update_existing_notifications()
...
def test_create_non_existing_notifications(event_published_notification, snapshot):
    NotificationImporter().create_non_existing_notifications()
